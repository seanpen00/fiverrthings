...
// Contract: MutantKaijuz
// Token ID: "MutantKaijuz"
// Token Symbol: "MKJZ"
// Author: Metaverse Solutions, LLC
// Visit us: metaversesolutions.ai
// ---- CONTRACT BEGINS HERE ----

pragma solidity ^0.8.0;

contract MutantKaijuz is ERC721Enumerable, Ownable {
  using Strings for uint256;
    ...
    returns (string memory)
  {
    require(
      _exists(tokenId),
      "ERC721Metadata: URI query for nonexistent MKJZ"
    );
